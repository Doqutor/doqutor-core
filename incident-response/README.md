...
To trigger this action: try adding, deleting or modifying any file in the frontend S3 bucket. On prod this would be: `s3://doqutore-frontend-frontends3bucket-*`
